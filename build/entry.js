...
(__oak_modularize(__Oak_String(`scenes/blocks/Transition.oak`),function _(){return ((PixelTransition,Transition,std)=>((std=__oak_module_import(__Oak_String(`std`))),Transition=function Transition(color_=null,tw=null){return ((createFG,makeTransition,self)=>((color_=(std.__oak_js_default)(color_,BLACK)),(tw=(std.__oak_js_default)(tw,(easings.easeOutSine??null))),(self=({})),createFG=function createFG(){return (add([rect(width(),height()),color(color_),opacity(1)]))},((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(tr,__oak_assgn_val):__oak_assgn_val===__Oak_Empty?delete (__oak_assgn_tgt.tr):(__oak_assgn_tgt.tr)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(self),createFG()),makeTransition=function makeTransition(speed=null,call=null,setOpacity=null){return (((self.tr??null).use)(opacity(setOpacity)),((self.tr??null).use)(call(speed)))},((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(fadeIn,__oak_assgn_val):__oak_assgn_val===__Oak_Empty?delete (__oak_assgn_tgt.fadeIn):(__oak_assgn_tgt.fadeIn)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(self),function _(speed=null,color=null){return (((__oak_cond)=>__oak_eq(__oak_cond,true)?((self.tr??null).use)(color):null)(!__oak_eq(color,null)),makeTransition(speed,fadeIn,0))}),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(fadeOut,__oak_assgn_val):__oak_assgn_val===__Oak_Empty?delete (__oak_assgn_tgt.fadeOut):(__oak_assgn_tgt.fadeOut)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(self),function _(speed=null,color=null){return (((__oak_cond)=>__oak_eq(__oak_cond,true)?((self.tr??null).use)(color):null)(!__oak_eq(color,null)),makeTransition(speed,function _(sp=null){return ((self.tr??null).fadeOut)(sp)},1))}),self))()},PixelTransition=function PixelTransition(color_=null){return ((createFG,makeTransition,self,unTransition)=>((color_=(std.__oak_js_default)(color_,BLACK)),(self=({})),createFG=function createFG(){return (add([rect(width(),height()),color(0,0,0),opacity(1)]))},((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(tr,__oak_assgn_val):__oak_assgn_val===__Oak_Empty?delete (__oak_assgn_tgt.tr):(__oak_assgn_tgt.tr)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(self),createFG()),makeTransition=function makeTransition(speed=null,color=null,amm=null){return ((time)=>((time=0),(std.loop)(function _(count=null,breaker=null){return ((__oak_cond)=>__oak_eq(__oak_cond,(((self.tr??null).opacity??null)<1))?wait(time,function _(){return ((time=__as_oak_string(time+speed)),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(opacity,__oak_assgn_val):__oak_assgn_val===__Oak_Empty?delete (__oak_assgn_tgt.opacity):(__oak_assgn_tgt.opacity)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string((self.tr??null)),__as_oak_string(((self.tr??null).opacity??null)+amm)))}):breaker())(true)})))()},unTransition=function unTransition(speed=null,color=null,amm=null){return ((time)=>((time=0),(std.loop)(function _(count=null,breaker=null){return ((__oak_cond)=>__oak_eq(__oak_cond,(((self.tr??null).opacity??null)>0))?wait(time,function _(){return ((time=__as_oak_string(time+speed)),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(opacity,__oak_assgn_val):__oak_assgn_val===__Oak_Empty?delete (__oak_assgn_tgt.opacity):(__oak_assgn_tgt.opacity)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string((self.tr??null)),(((self.tr??null).opacity??null)-amm)))}):breaker())(true)})))()},((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(fadeIn,__oak_assgn_val):__oak_assgn_val===__Oak_Empty?delete (__oak_assgn_tgt.fadeIn):(__oak_assgn_tgt.fadeIn)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(self),function _(speed=null,amm=null,color=null){return (((__oak_cond)=>__oak_eq(__oak_cond,true)?((self.tr??null).use)(color):null)(!__oak_eq(color,null)),makeTransition(speed,color,amm))}),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(fadeOut,__oak_assgn_val):__oak_assgn_val===__Oak_Empty?delete (__oak_assgn_tgt.fadeOut):(__oak_assgn_tgt.fadeOut)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(self),function _(speed=null,amm=null,color=null){return (((__oak_cond)=>__oak_eq(__oak_cond,true)?((self.tr??null).use)(color):null)(!__oak_eq(color,null)),unTransition(speed,color,amm))}),self))()},({PixelTransition,Transition,std})))()}),__oak_modularize(__Oak_String(`scenes/blocks/shakey.oak`),function _(){return ((shakey)=>(shakey=function shakey(obj=null){return ((STOP,draw_,off,ogp,on,returns,set,toggle)=>((ogp=(obj.pos??null)),(STOP=false),draw_=function draw_(){return ((__oak_cond)=>__oak_eq(__oak_cond,true)?(((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(pos,__oak_assgn_val):__oak_assgn_val===__Oak_Empty?delete (__oak_assgn_tgt.pos):(__oak_assgn_tgt.pos)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(obj),((ogp.clone)().add)(rand(),rand()))):null)(!STOP)},(returns=(obj.onUpdate)(draw_)),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(shakeyMod,__oak_assgn_val):__oak_assgn_val===__Oak_Empty?delete (__oak_assgn_tgt.shakeyMod):(__oak_assgn_tgt.shakeyMod)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(obj),({set:set=function set(v=null){return (STOP=v)},toggle:toggle=function toggle(){return set(!STOP)},on:on=function on(){return set(true)},off:off=function off(){return set(false)},returns,cancel:(returns.cancel??null),remove:function _(){return (off(),cancel())}})),returns))()},({shakey})))()}),__oak_modularize(__Oak_String(`scenes/init/boot.oak`),function _(){return ((dt,gwibble,rnd,shakey,std)=>((std=__oak_module_import(__Oak_String(`std`))),(rnd=__oak_module_import(__Oak_String(`random`))),(dt=__oak_module_import(__Oak_String(`datetime`))),(gwibble=loadFont(s(__Oak_String(`gwibble`)),s(__Oak_String(`/fonts/gwibble/font.ttf`)))),({shakey}=__oak_module_import(__Oak_String(`scenes/blocks/shakey.oak`))),scene(__Oak_String(`init`),function _(){return ((HIDE,SET,SHOW,TEXT,_ta,cn_title_text,name,names,track)=>((names=[__Oak_String(`SpectCOW`),__Oak_String(`SpcFORK`),__Oak_String(`SpectMEOW`),__Oak_String(`Midialive`),__Oak_String(`Seedw`),__Oak_String(`Spcv`),__Oak_String(`Comercialcheck`),__Oak_String(`Bull ahh mf`)]),(name=(rnd.choice)(names)),(cn_title_text=add([text(s(name),({font:s(__Oak_String(`gwibble`)),size:48,width:300,align:s(__Oak_String(`center`))})),color(BLACK),pos(center()),anchor(s(__Oak_String(`center`)))])),SET=function SET(v=null){return ((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(opacity,__oak_assgn_val):__oak_assgn_val===__Oak_Empty?delete (__oak_assgn_tgt.opacity):(__oak_assgn_tgt.opacity)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(cn_title_text),v)},SHOW=function SHOW(){return SET(1)},HIDE=function HIDE(){return SET(0)},TEXT=function TEXT(v=null){return ((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(text,__oak_assgn_val):__oak_assgn_val===__Oak_Empty?delete (__oak_assgn_tgt.text):(__oak_assgn_tgt.text)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(cn_title_text),v)},shakey(cn_title_text),(track=0),_ta=function _ta(amm=null){return (track=__as_oak_string(track+amm))},wait(_ta(3),function _(){return (HIDE(),TEXT(2024))}),wait(_ta(3),SHOW),wait(_ta(3),HIDE),wait(_ta((3/2)),function _(){return go(__Oak_String(`game`))})))()}),({dt,gwibble,rnd,shakey,std})))()}),__oak_modularize(__Oak_String(`scenes/init/main.oak`),function _(){return ((CHROMEOS,FLAGS__oak_qm,FirstInput__oak_qm,GLOBAL_LOADED_FILES,IS_IFRAME,PixelTransition,Transition,_b,beanSpr,cowingSpr,createBeatHandler,createGhosty,createPlayer,fi_,getFInput,ghostySpr,gwibble,introTexts,json,kaboomSpr,kaboom_bgSpr,loadBarSpr,loading_tempSpr,menuMusic,menu_logoSpr,newCut,playMenuMusic,rng,shakey,std,str)=>((std=__oak_module_import(__Oak_String(`std`))),(str=__oak_module_import(__Oak_String(`str`))),(json=__oak_module_import(__Oak_String(`json`))),(rng=__oak_module_import(__Oak_String(`random`))),(_b=__oak_module_import(__Oak_String(`scenes/init/boot.oak`))),(FirstInput__oak_qm=((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(FirstInput__oak_qm,__oak_assgn_val):__oak_assgn_val===__Oak_Empty?delete (__oak_assgn_tgt.FirstInput__oak_qm):(__oak_assgn_tgt.FirstInput__oak_qm)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(window),false)),(IS_IFRAME=(!__oak_eq((window.location??null),((window.parent??null).location??null)))),(CHROMEOS=((navigator.userAgent??null).includes)(__Oak_String(`CrOS`))),getFInput=function getFInput(){return ((holder)=>((holder=onClick(function _(){return ((FirstInput__oak_qm)=>((FirstInput__oak_qm=true),(holder.cancel)()))()}))))()},(fi_=getFInput()),(GLOBAL_LOADED_FILES=((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(GLOBAL_LOADED_FILES,__oak_assgn_val):__oak_assgn_val===__Oak_Empty?delete (__oak_assgn_tgt.GLOBAL_LOADED_FILES):(__oak_assgn_tgt.GLOBAL_LOADED_FILES)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(window),({txts:__Oak_String(``),RIGHTTOPTEXTCHOICES:({}),WEEKLIST:({}),WEEKSONGS:({}),STORYW:({})}))),({Transition,PixelTransition}=__oak_module_import(__Oak_String(`scenes/blocks/Transition.oak`))),({newCut}=__oak_module_import(__Oak_String(`scenes/ware/cutscene.oak`))),({shakey}=__oak_module_import(__Oak_String(`scenes/blocks/shakey.oak`))),(gwibble=null),(beanSpr=null),(ghostySpr=null),(menu_logoSpr=null),(loadBarSpr=null),(loading_tempSpr=null),(kaboomSpr=null),(kaboom_bgSpr=null),(cowingSpr=null),(introTexts=null),(menuMusic=null),playMenuMusic=function playMenuMusic(){return ((mm=play(__Oak_String(`freakyMenu`),({volume:0.5,loop:true}))))},createPlayer=function createPlayer(){return (add([sprite(s(__Oak_String(`bean`)),({anim:s(__Oak_String(`idle`))})),pos(center()),area(),body(),anchor(s(__Oak_String(`center`))),({score:0,misses:0,combo:0,combo_max:0,health:100})]))},createGhosty=function createGhosty(){return ((gh_)=>((gh_=add([sprite(s(__Oak_String(`ghosty`)),({anim:s(__Oak_String(`idle`)),animSpeed:0.5})),anchor(s(__Oak_String(`center`)))]))))()},createBeatHandler=function createBeatHandler(){return ((lastBeatTime)=>((lastBeatTime=0),(({activateBeat:function _(bpm=null){return ((beatInterval,currentTime)=>((beatInterval=(60000/bpm)),(currentTime=time()),((__oak_cond)=>__oak_eq(__oak_cond,true)?((lastBeatTime=currentTime),true):__oak_eq(__oak_cond,false)?false:null)(((currentTime-lastBeatTime)>(beatInterval/1000)))))()}}))))()},(FLAGS__oak_qm=({init__oak_qm:false})),scene(__Oak_String(`inputCheck`),function _(data=null){return ((next,onNotACPermissed)=>(({next}=data),onNotACPermissed=function onNotACPermissed(){return ((bean)=>((bean=createPlayer())))()},((__oak_cond)=>__oak_eq(__oak_cond,true)?((checkForAC_Allowed__oak_qm)=>(checkForAC_Allowed__oak_qm=function checkForAC_Allowed__oak_qm(){return ((__oak_trampolined_checkForAC_Allowed__oak_qm)=>((__oak_trampolined_checkForAC_Allowed__oak_qm=function _(){return ((__oak_cond)=>__oak_eq(__oak_cond,true)?(getFInput(),onNotACPermissed(),__oak_trampoline(__oak_trampolined_checkForAC_Allowed__oak_qm)):next())((__oak_left=>__oak_left===true?true:__oak_or(__oak_left,(!IS_IFRAME)))((!FirstInput__oak_qm)))}),__oak_resolve_trampoline(__oak_trampolined_checkForAC_Allowed__oak_qm)))()},checkForAC_Allowed__oak_qm()))():null)(!__oak_eq(next,null))))()}),scene(__Oak_String(`initLoading`),function _(){return ((AddText,FONT_SIZE,attemptLog,gwibble,kaboom_bgSpr,loader_text,log,lsnd,lspr,sucLog)=>(setBackground(BLACK),(FONT_SIZE=24),(loader_text=add([text(__Oak_String(``),({font:s(__Oak_String(`gwibble`)),size:FONT_SIZE})),pos(),anchor(s(__Oak_String(`topleft`)))])),AddText=function AddText(text=null){return (((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(text,__oak_assgn_val):__oak_assgn_val===__Oak_Empty?delete (__oak_assgn_tgt.text):(__oak_assgn_tgt.text)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(loader_text),__oak_push(__as_oak_string((loader_text.text??null)+s(text)),__Oak_String(`
`))))},AddText(__Oak_String(`Welcome to OKFunk!!!`)),AddText(__Oak_String(``)),log=function log(ii=null){return AddText(__oak_push(__Oak_String(`[okbf] `),ii))},attemptLog=function attemptLog(ii=null){return log(__oak_push(__Oak_String(`Attempting to load: `),ii))},sucLog=function sucLog(ii=null){return log(__oak_push(__Oak_String(`Got: `),ii))},attemptLog(__Oak_String(`gwibble`)),(gwibble=loadFont(s(__Oak_String(`gwibble`)),s(__Oak_String(`/fonts/gwibble/font.ttf`)))),AddText(keys(gwibble)),AddText(__Oak_String(``)),sucLog(__Oak_String(`gwibble`)),attemptLog(__Oak_String(`bean`)),(beanSpr=__oak_js_do(__Oak_String(`
  ...
  `))),AddText(keys(beanSpr)),AddText(__Oak_String(``)),sucLog(__Oak_String(`bean`)),attemptLog(__Oak_String(`ghosty`)),(ghostySpr=__oak_js_do(__Oak_String(`
  ...
  `))),AddText(keys(ghostySpr)),AddText(__Oak_String(``)),sucLog(__Oak_String(`ghosty`)),lspr=function lspr(name=null,path=null){return ((id,returns)=>((id=__oak_push(__Oak_String(`sprite:`),name)),attemptLog(id),(returns=OKloadSprite(name,path)),AddText(keys(returns)),AddText(__Oak_String(``)),sucLog(id),returns))()},lsnd=function lsnd(name=null,path=null){return ((id,returns)=>((id=__oak_push(__Oak_String(`sound:`),name)),attemptLog(id),(returns=loadSound(s(name),s(path))),AddText(keys(returns)),AddText(__Oak_String(``)),sucLog(id),returns))()},(menu_logoSpr=lspr(__Oak_String(`menu_logo`),__Oak_String(`sprites/menu/menu.png`))),(loadBarSpr=lspr(__Oak_String(`loadBar`),__Oak_String(`sprites/loadBar.png`))),(loading_tempSpr=lspr(__Oak_String(`loading_temp`),__Oak_String(`sprites/menu/kblfront.png`))),(kaboomSpr=lspr(__Oak_String(`kaboom`),__Oak_String(`sprites/ka.png`))),(kaboom_bgSpr=lspr(__Oak_String(`kaboom_bg`),__Oak_String(`sprites/boom.png`))),(cowingSpr=lspr(__Oak_String(`cowing`),__Oak_String(`cowingWhite.png`))),lsnd(__Oak_String(`freakyMenu`),__Oak_String(`sounds/freakyMenu.ogg`)),lsnd(__Oak_String(`confirmMenu`),__Oak_String(`sounds/confirmMenu.ogg`)),lsnd(__Oak_String(`cancelMenu`),__Oak_String(`sounds/cancelMenu.ogg`)),lsnd(__Oak_String(`scrollMenu`),__Oak_String(`sounds/scrollMenu.ogg`)),((__oak_assgn_tgt,__oak_assgn_val)=>(__is_oak_string(__oak_assgn_tgt)?__oak_assgn_tgt.assign(intialLoad,__oak_assgn_val):__oak_assgn_val===__Oak_Empty?delete (__oak_assgn_tgt.intialLoad):(__oak_assgn_tgt.intialLoad)=__oak_assgn_val,__oak_assgn_tgt))(__as_oak_string(window),({gwibble,beanSpr,ghostySpr,menu_logoSpr,loadBarSpr,loading_tempSpr,kaboomSpr,kaboom_bgSpr})),load((Promise.all)([((fetch(__Oak_String(`code/txt.txt`)).then)(function _(res=null){return (res.text)()}).then)(function _(res=null){return (introTexts=string(res))})])),go(__Oak_String(`inputCheck`),({next:function _(){return go(__Oak_String(`intro`))}}))))()}),scene(__Oak_String(`intro`),function _(){return ((cowingLogo,cutArr,firstTrack,txt)=>(setBackground(BLACK),(firstTrack=newCut()),(txt=__oak_js_do(__Oak_String(`
    add([
      text(
        "KaboomFunkin\\'",
        {
